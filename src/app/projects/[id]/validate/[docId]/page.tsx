...
const isAnalystRole = (role: string | null) => role === 'ANALYST' || role === 'ANALISTA';
...
export default function ValidateDocumentPage() {
    ...
    useEffect(() => {
        ...
        `)
            ...
            if (isAnalystRole(role) && hasConfidentialFields) {
                ...
                <div className="w-1/2 flex flex-col bg-slate-50">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-slate-50">
                        ...
                        {document.definition.fields
                            .filter((f: any) => !isAnalystRole(currentUserRole) || f.is_visible_to_analyst)
                            .map((field: any) => {
